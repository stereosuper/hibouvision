...
session_start();
echo $_SESSION['captcha']['id_question'];
...
if(isset($_POST['submit'])){
 	...
 	if(empty($status)){
        ...
        $sent = mail($mailto, $subject, $content);
				...
				<div class="bg-grey">
					<div class="container-small clearfix">
						<div class="text">
							...
							<p>Envie d’en savoir plus, d’avoir une démo ou de connaître l’ensemble des fonctionnalités ? Nous sommes là pour vous aider ! <a href="mailto:contact@hibouvision.com" style="color:#feb506;">contact@hibouvision.com</a></p>
						</div>
						<div id="formulaire">
							...
							<?php }else{ ?>
								...
								?>
								<form method="post" action="#contact" method='POST' style='display:none;'>
