...
<html class="no-js" lang='fr-FR'>
	<head>
	  	...
	  	<title>Hibou Vision - Disclaimer</title>
		...
		<div id="main">
			<div class="container">
				<div id="mentions-legales">
					...
					<p>
						<strong>Owner</strong> : Sensor Factory – SAS – 3 chemin du pressoir Chenaie 44100 NANTES<br /><strong>Design and creation</strong> : <a href="http://www.stereosuper.fr" target="_blank">Stereosuper</a><br /><strong>Publication director</strong> : Sensor Factory<br /><strong>Webmaster</strong> : Sensor Factory<br /><strong>Hosting</strong> : GANDI</p>

					<p>The information contained in this website is for general information purposes only.<p>
					<p>The information is provided by <a href='http://www.sensorfactory.eu' title="SENSOR FACTORY">SENSOR FACTORY</a> and while we endeavour to keep the information up to date and correct, we make no representations or warranties of any kind, express or implied, about the completeness, accuracy, reliability, suitability or availability with respect to the website or the information, products, services, or related graphics contained on the website for any purpose.</p>
					...
					<p>Through this website you are able to link to other websites which are not under the control of <a href='http://www.sensorfactory.eu' title="SENSOR FACTORY">SENSOR FACTORY</a>. We have no control over the nature, content and availability of those sites. The inclusion of any links does not necessarily imply a recommendation or endorse the views expressed within them.</p>
					<p>Every effort is made to keep the website up and running smoothly. However, <a href='http://www.sensorfactory.eu' title="SENSOR FACTORY">SENSOR FACTORY</a> takes no responsibility for, and will not be liable for, the website being temporarily unavailable due to technical issues beyond our control.</p>
				</div>
			</div>
		</div>
		<footer>
